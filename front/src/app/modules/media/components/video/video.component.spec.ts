...
import { OpspotVideoComponent } from './video.component';
...
class OpspotVideoTorrentPlayerMock implements OpspotPlayerInterface {
  @Input() muted: boolean;
  @Input() poster: string;
  @Input() autoplay: boolean;
  @Input() src: string;
...
export class OpspotVideoVolumeSliderMock {
  @Input() player;
  bindToElement() {}
}
...
export class OpspotVideoQualitySelectorMock {
...
export class OpspotVideoProgressBarMock {
  @Input() player;
...
describe('OpspotVideo', () => {
  let comp: OpspotVideoComponent;
  let fixture: ComponentFixture<OpspotVideoComponent>;
  ...
  beforeEach((done) => {
    ...
    fixture = TestBed.createComponent(OpspotVideoComponent);
    clientMock.response = {};
  ...
  it('should have a Play icon and a Control bar', () => {
    const playIcon = fixture.debugElement.query(By.css('.opspot-video-play-icon'));
