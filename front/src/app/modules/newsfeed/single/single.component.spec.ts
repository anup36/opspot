...
describe('NewsfeedSingleComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [MaterialMock, OpspotActivityMock, NewsfeedSingleComponent],
  ...
  it('it should show the activity', () => {
    fixture.detectChanges();
    expect(fixture.debugElement.query(By.css('.opspot-list opspot-activity'))).not.toBeNull();
  });
