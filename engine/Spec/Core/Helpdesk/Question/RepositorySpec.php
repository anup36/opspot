...
namespace Spec\Opspot\Core\Helpdesk\Question;
...
use Opspot\Core\Helpdesk\Question\Question;
...
class RepositorySpec extends ObjectBehavior
{
    ...
    private $esClient;
    /** @var \Opspot\Core\Helpdesk\Category\Repository */
    private $categoryRepo;

    function let(
        Cassandra\Client $cassandraClient,
        ElasticSearch\Client $esClient,
        \Opspot\Core\Helpdesk\Category\Repository $categoryRepo
    )
    {
