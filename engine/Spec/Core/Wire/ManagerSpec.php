...
namespace Spec\Opspot\Core\Wire;

use Opspot\Core;
use Opspot\Core\Blockchain\Transactions\Manager as BlockchainManager;
use Opspot\Core\Blockchain\Transactions\Transaction;
use Opspot\Core\Config;
use Opspot\Core\Data\cache\Redis;
use Opspot\Core\Queue\SQS\Client;
use Opspot\Core\Wire\Repository;
use Opspot\Core\Wire\Subscriptions\Manager as SubscriptionsManager;
use Opspot\Core\Wire\Wire as WireModel;
...
class ManagerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Wire\Manager');
    }
