...
use Opspot\Core\Blockchain\Transactions\Manager;
use Opspot\Core\Blockchain\Transactions\Repository;
use Opspot\Core\Blockchain\Transactions\Transaction;
use Opspot\Core\Blockchain\Wallets\OffChain\Cap;
use Opspot\Core\Blockchain\Wallets\OffChain\Transactions;
use Opspot\Core\Blockchain\Services\Ethereum;
use Opspot\Core\Blockchain\Wallets\OffChain\Withholding\Repository as WithholdingRepository;
use Opspot\Core\Blockchain\Wallets\OffChain\Withholding\Withholding;
use Opspot\Core\Config\Config;
use Opspot\Core\Data\Cassandra\Thrift\Lookup;
use Opspot\Core\Data\Locks\LockFailedException;
use Opspot\Core\Di\Di;
use Opspot\Core\Payments\Customer;
use Opspot\Core\Payments\Sale;
use Opspot\Core\Payments\Stripe\Stripe;
use Opspot\Core\Util\BigNumber;
use Opspot\Entities\Boost\Network;
use Opspot\Entities\Boost\Peer;
use Opspot\Entities\User;
use Opspot\Core\Data\Locks\Redis as Locks;
...
class PaymentSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Boost\Payment');
    }
