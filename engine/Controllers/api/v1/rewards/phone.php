<?php
/**
 * Opspot API for onboarding to the Rewards System
 */

namespace Opspot\Controllers\api\v1\rewards;
            ...
            switch ($pages[0]) {
                ...
                case 'verify':
                    ...
                    if ($twofactor->verifyCode($secret, $code, 1)) {
                        ...
                        return Factory::response([
                            'status' => 'success',
                            'message' => 'You have successfully onboarded to Opspot Rewards System'
                        ]);
                    } else {
