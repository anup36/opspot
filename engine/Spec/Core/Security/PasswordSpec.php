...
class PasswordSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Security\Password');
    }
    ...
    public function it_should_notice_to_rehash_password()
    {
        ...
        $this->shouldThrow('Opspot\Core\Security\Exceptions\PasswordRequiresHashUpgradeException')->during('check', [$user, 'foobar']);
    }
