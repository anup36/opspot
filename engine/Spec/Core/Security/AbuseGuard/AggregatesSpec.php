...
class AggregatesSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Security\AbuseGuard\Aggregates');
    }
    ...
    function it_should_get_down_votes(Client $client)
    {
        ...
        $client->request(Argument::type('Opspot\Core\Data\ElasticSearch\Prepared\Search'))->willReturn($result);
