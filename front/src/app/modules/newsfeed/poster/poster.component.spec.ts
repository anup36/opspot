...
describe('PosterComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [
        ...
        MockComponent({ selector: 'opspot-rich-embed', inputs: ['src', 'preview', 'maxheight', 'cropimage'] }),
  ...
  it("should show the user's avatar", () => {
    const img: DebugElement = fixture.debugElement.query(By.css('.post .mdl-card__supporting-text .opspot-avatar img'));
