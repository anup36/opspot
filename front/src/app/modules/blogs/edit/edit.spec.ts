...
describe('BlogEdit', () => {
  ...
  it('should have an instance of opspot-textarea used for the title', () => {
  ...
  it('should have an instance of m-inline-editor used for the description', () => {
    expect(fixture.debugElement.query(By.css('.opspot-blog-descriptions > m-inline-editor'))).not.toBeNull();
  });
