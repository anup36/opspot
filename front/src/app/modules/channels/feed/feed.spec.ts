...
describe('ChannelFeed', () => {
  ...
  it('poster should be on top if owner', () => {
    comp.user.guid = '1000';
    fixture.detectChanges();
    const poster = fixture.debugElement.query(By.css('opspot-newsfeed-poster'));
    const activities = fixture.debugElement.queryAll(By.css('opspot-activity'));
  ...
  it('should add the activities when no refresh', fakeAsync(() => {
    comp.user.guid = '1000';
    comp.loadFeed(false);
    let activities = fixture.debugElement.queryAll(By.css('opspot-activity'));
    fixture.detectChanges();
    ...
    expect(clientMock.get.calls.mostRecent().args[0]).toEqual('api/v1/newsfeed/personal/1000');
    fixture.detectChanges();
    activities = fixture.debugElement.queryAll(By.css('opspot-activity'));
    expect(comp.feed.length).toBe(5);
    expect(activities.length).toBe(5);
  }));
