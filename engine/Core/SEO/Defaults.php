...
class Defaults
{
    ...
    public function init()
    {
        Manager::setDefaults([
          ...
          'smartbanner:title' => 'Opspot',
          'smartbanner:author' => 'Opspot.com',
          ...
          'smartbanner:button-url-apple' => 'https://itunes.apple.com/app/opspot-com/id961771928',
          'smartbanner:button-url-google' => 'https://play.google.com/store/apps/details?id=com.opspot.mobile',
        ...
        Manager::add('/crypto', function ($slugs = []) {
            return [
                'title' => 'The Opspot Token',
                'description' => 'Coming soon',
                'og:title' => 'The Opspot Token',
        ...
        Manager::add('/canary', function ($slugs = []) {
            return [
                'title' => 'Opspot Canary',
                'description' => 'Receive the latest Opspot features before everyone else',
                'og:title' => 'Opspot Canary',
                'og:description' => 'Receive the latest Opspot features before everyone else',
                'og:url' => '/canary',
        ...
        Manager::add('/newsfeed', function ($slugs = []) {
            if (isset($slugs[0]) && is_numeric($slugs[0])) {
                ...
                $meta = [
                  ...
                  'twitter:site' => '@opspot',
                  'twitter:card' => 'summary',
                  'al:ios:url' => 'opspot://activity/' . $activity->guid,
                  'al:android:url' => 'opspot://opspot/activity/' . $activity->guid,
        ...
        Manager::add('/wallet/tokens/contributions', function ($slugs = []) {
            $meta = [
                ...
                'description' => 'Keep track of your contributions to Opspot',
                'og:title' => 'Contributions Ledger',
                'og:description' => 'Keep track of your contributions to Opspot',
        ...
        $marketing = [
            ...
            'wallet' => [
                'title' => 'Wallet',
                'description' => 'Manage all of your transactions and earnings on Opspot',
                'image' => 'assets/photos/graph.jpg'
            ],
            'wire' => [
                'title' => 'Wire',
                'description' => 'Exchange tokens with other channels on Opspot',
            ...
            'localization' => [
                'title' => 'Localization',
                'description' => 'Help translate Opspot into every global language',
            ...
            'faq' => [
                'title' => 'FAQ',
                'description' => 'Everything you need to know about Opspot',
                'image' => 'assets/photos/canyon.jpg'
            ],
            'jobs' => [
                'title' => 'Join the team',
                'description' => 'Work with Opspot.com',
                'image' => 'assets/photos/canyon.jpg'
            ],
            'wallet/101' => [
                'title' => 'Token 101',
                'description' => 'Everything you need to know about Opspot Tokens',
                'image' => 'assets/photos/canyon.jpg',
            ],
            'wallet/tokens/101' => [
                'title' => 'Token 101',
    ...
    public function channelHandler($slugs = []) 
    {
        ...
        if (isset($username) && is_string($username)) {
            ...
            return $meta = [
                ...
                'twitter:site' => '@opspot',
                'twitter:card' => 'summary',
                'al:ios:url' => 'opspot://channel/' . $user->guid,
                'al:android:url' => 'opspot://opspot/channel/' . $user->guid,
                'al:ios:app_name' => 'Opspot',
