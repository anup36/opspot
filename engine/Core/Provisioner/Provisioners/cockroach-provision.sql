...
CREATE TABLE opspot.entity_hashtags (
  guid INT NOT NULL,
...
CREATE TABLE opspot.helpdesk_categories (
  uuid UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE opspot.helpdesk_faq (
  uuid UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE opspot.helpdesk_votes (
...
CREATE TABLE opspot.hidden_hashtags (
  hashtag STRING NOT NULL,
...
CREATE TABLE opspot.notification_batches (
...
CREATE TABLE opspot.notifications (
  uuid UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE opspot.suggested_tags (
  guid INT NOT NULL,
  rating INT NULL,
  type STRING NULL,
  score INT NULL,
...
CREATE TABLE opspot.user_hashtags (
  guid INT NOT NULL,
  hashtag STRING NOT NULL,
  CONSTRAINT "primary" PRIMARY KEY (guid ASC, hashtag ASC),
