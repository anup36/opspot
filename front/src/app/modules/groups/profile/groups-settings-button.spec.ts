...
describe('GroupsSettingsButton', () => {
  ...
  function getMenuItem(i: number): DebugElement {
    return fixture.debugElement.query(By.css(`.opspot-dropdown-menu .mdl-menu__item:nth-child(${i})`))
  }
  ...
  it('should have a button and a menu', () => {
    ...
    expect(fixture.debugElement.query(By.css('.opspot-dropdown-menu'))).not.toBeNull();
  });

  it('should have button that lets you toggle the menu', () => {
    const menu = fixture.debugElement.query(By.css('.opspot-dropdown-menu'));
