...
namespace Spec\Opspot\Core\Rewards;

use Opspot\Core\Config;
use Opspot\Core\Data\ElasticSearch\Client;
use Opspot\Core\Di\Di;
use Opspot\Core\Rewards\ReferralValidator;
use Opspot\Core\Rewards\OfacBlacklist;
use Opspot\Core\Rewards\JoinedValidator;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

use Opspot\Core\Blockchain\Wallets\OffChain\Transactions;
use Opspot\Core\SMS\SMSServiceInterface;
use Opspot\Core\Security\TwoFactor;
...
class JoinSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Rewards\Join');
    }
