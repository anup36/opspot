        ...
        <td style="background:#FFF; padding: 0; border: 1px solid #ececec;">
            <table cellspacing="0" cellpadding="0" border="0" width="600" align="center">
                ...
                if (isset($object->remind_object) && $object->remind_object) {
                    ...
                    $obj = new Opspot\Entities\Activity($object->remind_object);
                ...
                <tr>
                    <td>
                        <table cellspacing="0" cellpadding="0" border="0" width="600" align="center"
                            ...
                            <tr>
                                <td>
                                    <img src="<?php echo Opspot\Core\Config::_()->get('cdn_assets_url') ?>front/public/assets/repeat-icon.png"
                                            width="24px" style="border-radius:50%; vertical-align:middle;">

                                    <img src="<?php echo Opspot\Core\Config::_()->get('cdn_url') . '/icon/' . $object->ownerObj['guid']?>/small/<?php echo $object->ownerObj['icontime']?>"
                                            width="24px" style="border-radius:50%; vertical-align:middle;">
                ...
                <tr>
                    <td>
                        <table cellspacing="8" cellpadding="8" border="0" width="600" align="center">
                            <tr>
                                <td width="50">
                                    <img src="<?php echo Opspot\Core\Config::_()->get('cdn_url') . '/icon/' . $postOwner['guid']?>/icon/<?= $postOwner['guid'] . '/medium/' . $postOwner['icontime'] ?>"
