...
describe('NewsfeedComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [
        ...
        MockComponent({ selector: 'opspot-card-user', inputs: ['object'], template: '' }),
  ...
  it('should have a User card in the sidebar', () => {
    expect(fixture.debugElement.query(By.css('.m-newsfeed--sidebar opspot-card-user'))).not.toBeNull();
  });
  ...
  xit("should have a 'Buy Opspot Tokens' button in the sidebar", () => {
    ...
    expect(fixture.debugElement.query(By.css('.m-newsfeed--sidebar .m-newsfeed--buy-tokens div')).nativeElement.textContent).toContain('Buy Opspot Tokens');
  });
