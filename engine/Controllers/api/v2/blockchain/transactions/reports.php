...
namespace Opspot\Controllers\api\v2\blockchain\transactions;

use Opspot\Core\Di\Di;
use Opspot\Interfaces;
use Opspot\Api\Factory;
use Opspot\Core\Session;
use Opspot\Core\Util\CsvExporter;
use Opspot\Core\Blockchain\Reports\Manager;
...
class reports implements Interfaces\Api, Interfaces\ApiAdminPam
{
    ...
    public function get($pages)
    {
        ...
        $data = $manager
            ->setReport("Opspot\Core\Blockchain\Reports\\$report")
            ->setParams($params)
            ->get();
