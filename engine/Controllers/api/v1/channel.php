    ...
    public function post($pages)
    {
        ...
        switch ($pages[0]) {
            ...
            case "banner":
                ...
                $item = new \Opspot\Entities\Object\Carousel();
                $item->title = '';
                ...
                break;
            case "carousel":
              $item = new \Opspot\Entities\Object\Carousel(isset($_POST['guid']) ? $_POST['guid'] : null);
              $item->access_id = ACCESS_PUBLIC;
    ...
    public function delete($pages)
    {
        ...
        switch ($pages[0]) {
            case "carousel":
                ...
                $item = new \Opspot\Entities\Object\Carousel($pages[1]);
                $item->delete();
                break;
            default:
