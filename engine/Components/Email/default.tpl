          ...
          <td>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td bgcolor="#ffffff" style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:20px">
                      ...
                      <p align="right">
                        <a href="https://ops.doesntexist.com/?__e_ct_guid=<?= $vars['guid']?>" style="text-decoration:none;">
            ...
            <table cellspacing="8" cellpadding="8" border="0" width="300" align="center">
              <tbody>
                ...
                <tr>
                  <td>
                    <a href="https://ops.doesntexist.com/emails/unsubscribe/<?= $vars['username']?>/<?= $vars['email']?>/<?= $vars['campaign']?><?= '/' . $vars['topic']?>?__e_ct_guid=<?= $vars['guid']?>?campaign=<?= $vars['campaign'] ?>&topic=<?= $vars['topic'] ?>&state=<?= $vars['state'] ?>" align="center" style="color:#888">
                      Unsubscribe 
                    </a>
                    from this type of email. 
                  </td>
                  <td>
                    <a href="https://ops.doesntexist.com/settings/emails" align="center" style="color:#888">
