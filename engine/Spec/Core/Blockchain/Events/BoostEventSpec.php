...
namespace Spec\Opspot\Core\Blockchain\Events;
...
class BoostEventSpec extends ObjectBehavior
{
    ...
    function let(Client $mongo, Repository $txRepository, \Opspot\Core\Boost\Repository $boostRepository, Config $config)
    {
    ...
    {
        $this->shouldHaveType('Opspot\Core\Blockchain\Events\BoostEvent');
    }
