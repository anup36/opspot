...
namespace Opspot\Core\Feeds\Suggested;
...
class Manager
{
    ...
    /** @var \Opspot\Core\Hashtags\Entity\Repository */
    ...
    {
        //\Opspot\Core\Security\ACL::$ignore = true;
        $scores = [];
        ...
        //\Opspot\Core\Security\ACL::$ignore = false;
    }
