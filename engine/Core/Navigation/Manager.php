<?php
/**
 * Opspot Navigation Manager
 */
namespace Opspot\Core\Navigation;
...
class Manager
{
    ...
    private static function defaults()
    {
        ...
        /*self::add((new Item())
            ...
            ->setPath('wallet')
            ->setExtras(array(
                'counter' => (int) Core\Session::isLoggedIn() ? \Opspot\Helpers\Counters::get(Core\Session::getLoggedinUser()->guid, 'points', false) : 0
            )),
            'topbar'
        );
    ...
    public static function export($container = null)
    {
        ...
        /* Initialize modules */
        (new \Opspot\Core\Blogs\Navigation())->setup();
