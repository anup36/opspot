...
namespace Spec\Opspot\Core\Messenger\Encryption;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

use Opspot\Entities\User;
use Opspot\Entities\Message;
use Opspot\Entities\Conversation;
use Opspot\Core\Messenger\Keystore;

class OpenSSLSpec extends ObjectBehavior
{
    public function it_is_initializable()
    {
        $this->shouldHaveType('Opspot\Core\Messenger\Encryption\OpenSSL');
    }

    public function it_should_set_a_message_entity(Message $message)
    {
        $this->setMessage($message)->getMessage()->shouldHaveType('Opspot\Entities\Message');
    }
