...
import { OpspotPlayerInterface } from './player.interface';
...
export class OpspotVideoTorrentPlayer implements OnInit, AfterViewInit, OnDestroy, OpspotPlayerInterface {
