...
namespace Spec\Opspot\Core\Sessions;

use Opspot\Core\Sessions\Manager;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

use Opspot\Core\Sessions\Repository;
use Opspot\Core\Sessions\Session;
