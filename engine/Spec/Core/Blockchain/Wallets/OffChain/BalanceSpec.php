...
use Opspot\Core\Blockchain\Wallets\OffChain\Sums;
use Opspot\Core\Blockchain\Wallets\OffChain\Withholding\Sums as WithholdingSums;
...
class BalanceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Blockchain\Wallets\OffChain\Balance');
    }
