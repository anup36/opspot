...
use Opspot\Core\Analytics\UserStates\Manager;
use Opspot\Core\Data\ElasticSearch\Client;
use Opspot\Core\Analytics\UserStates\ActiveUsersIterator;
use Opspot\Core\Analytics\UserStates\UserStateIterator;
use Opspot\Core\Queue;
use PhpSpec\ObjectBehavior;
use Opspot\Core\Data\ElasticSearch\Prepared;
...
class ManagerSpec extends ObjectBehavior
{
    ...
    public function let(Client $client, Queue\RabbitMQ\Client $queue)
    {
        ...
        $this->beConstructedWith($client, 'opspot-metrics-*', $queue, $activeUsersIterator, $userStateIterator);
        $this->client = $client;
        $this->queue = $queue;
    }
