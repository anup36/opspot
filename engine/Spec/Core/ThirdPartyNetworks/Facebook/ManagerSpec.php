...
namespace Spec\Opspot\Core\ThirdPartyNetworks\Facebook;

use Facebook\Facebook as FacebookSDK;
use Facebook\Helpers\FacebookRedirectLoginHelper;
use Opspot\Core;
use Opspot\Core\ThirdPartyNetworks\Networks\Facebook;
...
class ManagerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\ThirdPartyNetworks\Facebook\Manager');
    }
