...
import { OpspotVideoQualitySelector } from './quality-selector.component';

describe('OpspotVideoQualitySelector', () => {
  let comp: OpspotVideoQualitySelector;
  let fixture: ComponentFixture<OpspotVideoQualitySelector>;

  beforeEach(async(() => {

    TestBed.configureTestingModule({
      declarations: [ OpspotVideoQualitySelector ], // declare the test component
      imports: [ 
        FormsModule,
        RouterTestingModule,
        NgCommonModule ],
  ...
  beforeEach((done) => {
    ...
    fixture = TestBed.createComponent(OpspotVideoQualitySelector);
