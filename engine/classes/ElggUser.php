...
class ElggUser extends ElggEntity
	...
	protected function loadFromGUID($guid){
		...
		/** @var \Opspot\Core\Data\Call $db */
		$db = Opspot\Core\Di\Di::_()->get('Database\Cassandra\Entities');
	...
	protected function loadFromLookup($string){
        //$cacher = Opspot\Core\Data\cache\factory::build();
        //if($guid = $cacher->get("lookup:$string")){
        //    return $this->loadFromGUID(key($guid));
        //}

        /** @var \Opspot\Core\Data\lookup $lookup */
        $lookup = Opspot\Core\Di\Di::_()->get('Database\Cassandra\Data\Lookup');
	...
	public function save() {
        ...
        $db = new Opspot\Core\Data\Call('user_index_to_guid');
    ...
    public function isAdmin() {
        ...
        $whitelist = Opspot\Core\Di\Di::_()->get('Config')->get('admin_ip_whitelist');
