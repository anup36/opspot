...
export class OpspotVideoComponent {
  ...
  @ViewChild('progressBar') progressBar: OpspotVideoProgressBar;
  @ViewChild('volumeSlider') volumeSlider: OpspotVideoVolumeSlider;
  @ViewChild('player') playerRef: OpspotPlayerInterface;
