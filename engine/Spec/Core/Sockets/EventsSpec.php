...
use Opspot\Core\Sockets\Binary;
use Opspot\Core\Sockets\MsgPack;
use Opspot\Core\Sockets\Events as OriginalEventsClass;
use Opspot\Core\Data\PubSub\Redis\Client as RedisPubSubClient;
...
class EventsSpec extends ObjectBehavior
{
    function it_is_initializable(RedisPubSubClient $redis)
    {
        ...
        $this->shouldHaveType('Opspot\Core\Sockets\Events');
    }
