...
function elggmulti_db_connect() {
	...
	//	require_once (dirname(dirname(dirname(__FILE__))) . '/vendors/phpcassa/lib/autoload.php');
		...
		$cfs = array('opspotuser_to_domain', 'domain');
...
function elggmulti_required_plugins() {
	return array(	'pluginmanager' => array('activated'=>true), 
					'opspot' => array('activated'=>true), 
					'opspotmulti_pluginmanager' => array('activated'=>true),
					'opspot_themeconfig' => array('activated'=>true),
					'opspot_theme_selector' => array('activated'=>true),
