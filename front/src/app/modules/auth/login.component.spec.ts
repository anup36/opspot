...
describe('LoginComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [MaterialMock, OpspotFormLoginMock, OpspotFormRegisterMock, LoginComponent],
  ...
  it('should have a login form', () => {
    ...
    expect(fixture.debugElement.query(By.css('opspot-form-login'))).not.toBeNull();
  });
  ...
  it('should have a register form', () => {
    ...
    expect(fixture.debugElement.query(By.css('opspot-form-register'))).not.toBeNull();
  });
