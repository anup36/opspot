...
namespace Spec\Opspot\Core\Subscriptions;

use Opspot\Core\Subscriptions\Manager;
use Opspot\Core\Subscriptions\Repository;
use Opspot\Core\Subscriptions\Subscription;
use Opspot\Core\Subscriptions\Delegates;
