...
namespace Spec\Opspot\Core\SMS\Services;
...
class SNSSpec extends ObjectBehavior
{
    function it_is_initializable(SnsClient $client)
    {
        ...
        $this->shouldHaveType('Opspot\Core\SMS\Services\SNS');
    }
    ...
    function it_should_return_true_if_SMS_was_sent(Config $config, SnsClient $client)
    {
        ...
        $client->publish(Argument::that(function ($args) {
            ...
            return $args['SenderID'] === 'Opspot' && $args['SMSType'] === 'Transactional' && $args['Message'] === 'hello' && $args['PhoneNumber'] === '+44 1234';
        }))
            ->shouldBeCalled()
    ...
    function it_should_return_false_if_SMS_was_not_sent(Config $config, SnsClient $client)
    {
        ...
        $client->publish(Argument::that(function ($args) {
            ...
            return $args['SenderID'] === 'Opspot' && $args['SMSType'] === 'Transactional' && $args['Message'] === 'hello' && $args['PhoneNumber'] === '+1 1234';
        }))
            ->shouldBeCalled()
            ->willReturn([]);
    ...
    function it_should_support_us_numbers_without_intl_code(Config $config, SnsClient $client)
    {
        ...
        $client->publish(Argument::that(function ($args) {
            ...
            return $args['SenderID'] === 'Opspot' && $args['SMSType'] === 'Transactional' && $args['Message'] === 'hello' && $args['PhoneNumber'] === '+1234';
        }))
            ->shouldBeCalled()
            ->willReturn(['MessageId' => 'test123']);
