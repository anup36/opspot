...
namespace Spec\Opspot\Core\Data\Locks;

use Opspot\Core\Data\Redis\Client as RedisServer;
use Opspot\Core\Data\Locks\KeyNotSetupException;
...
class RedisSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith($this->redis);
        $this->shouldHaveType('Opspot\Core\Data\Locks\Redis');
    }
