...
namespace Spec\Opspot\Core\Notification\PostSubscriptions;

use Opspot\Core\Notification\PostSubscriptions\PostSubscription;
use Opspot\Core\Notification\PostSubscriptions\Repository;
...
class ManagerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Notification\PostSubscriptions\Manager');
    }
