...
import { OpspotVideoProgressBar } from './progress-bar.component';
...
describe('OpspotVideoProgressBar', () => {
  let comp: OpspotVideoProgressBar;
  let fixture: ComponentFixture<OpspotVideoProgressBar>;
  let window: any = {};
  let e: Event;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [ OpspotVideoProgressBar ], // declare the test component
      imports: [ 
        FormsModule,
        RouterTestingModule,
        NgCommonModule ],
  ...
  beforeEach((done) => {
    ...
    fixture = TestBed.createComponent(OpspotVideoProgressBar);
