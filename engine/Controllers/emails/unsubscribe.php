<?php
/**
 * Opspot main page controller
 */
namespace Opspot\Controllers\emails;
...
class unsubscribe extends core\page implements Interfaces\page
{
    ...
    public function get($pages)
    {
        ...
        echo <<<HTML
        <img src="https://d15u56mvtglc6v.cloudfront.net/front/public/assets/logos/medium-production.png" alt="Opspot.com" align="middle" width="200px" height="80px"/>
    <h1 style="color:rgb(119, 119, 119);">SUCCESS. You won't receive any more emails like this to @$user->username</h1>
    <strong style="color:rgb(119, 119, 119);">You can also choose to stop receiving all email from Opspot or adjust your other <a style="color:rgb(119, 119, 119);" href="{$siteUrl}settings/emails">email settings</a>.</strong>
HTML;
    }
