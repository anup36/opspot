...
use Opspot\Core\Notification\Manager as NotificationManager;
use Opspot\Core\Notification\Batches\Manager as NotificationBatches;
...
class NotificationsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Groups\Notifications');
    }
