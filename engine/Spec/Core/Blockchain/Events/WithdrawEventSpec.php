...
use Opspot\Core\Rewards\Withdraw\Manager;
...
class WithdrawEventSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Blockchain\Events\WithdrawEvent');
    }
    ...
    function it_should_complete_withdrawal_on_event()
    {
        ...
        }), Argument::type('\Opspot\Core\Blockchain\Transactions\Transaction'))
            ->shouldBeCalled();
