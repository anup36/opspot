...
class RepositorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Payments\Subscriptions\Repository');
    }
    ...
    function it_should_getList()
    {
        ...
        $results[0]->shouldHaveType('Opspot\\Core\\Payments\\Subscriptions\\Subscription');
        $results[0]->getPlanId()->shouldBe('a');
        $results[1]->shouldHaveType('Opspot\\Core\\Payments\\Subscriptions\\Subscription');
