...
namespace Spec\Opspot\Core\Blockchain\Services;

use Opspot\Core\Blockchain\Config;
use Opspot\Core\Blockchain\GasPrice;
use Opspot\Core\Http\Curl\JsonRpc\Client as JsonRpc;
...
class EthereumSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Blockchain\Services\Ethereum');
    }
