...
class XSSSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Security\XSS');
    }
    ...
    {
        $dirty = "<a href=\"https://www.ops.doesntexist.com\">take me home</a>";
        $this->clean($dirty)->shouldReturn('<?xml encoding="utf-8" ?>'."<a href=\"https://www.ops.doesntexist.com\" target=\"_blank\" rel=\"noopener noreferrer nofollow\">take me home</a>");
    }
    ...
    {
        $dirty = "<img src=\"https://ops.doesntexist.com/fakeimg.png\">";
        $this->clean($dirty)->shouldReturn('<?xml encoding="utf-8" ?>'."<img src=\"https://ops.doesntexist.com/fakeimg.png\">");
    }

    public function it_should_set_width_and_height()
    {
        $dirty = "<img src=\"https://ops.doesntexist.com/fakeimg.png\" width=\"300\" height=\"600\">";
        $this->clean($dirty)->shouldReturn('<?xml encoding="utf-8" ?>'."<img src=\"https://ops.doesntexist.com/fakeimg.png\" width=\"300\" height=\"600\">");
    }
