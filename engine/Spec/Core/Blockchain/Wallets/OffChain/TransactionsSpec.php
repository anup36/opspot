...
namespace Spec\Opspot\Core\Blockchain\Wallets\OffChain;
...
class TransactionsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Blockchain\Wallets\OffChain\Transactions');
    }
