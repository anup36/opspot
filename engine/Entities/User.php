...
class User extends \ElggUser
{
    ...
    {
        return \Opspot\Helpers\Subscriptions::subscribe($this->guid, $guid, $data);
    }
    ...
    {
        return \Opspot\Helpers\Subscriptions::unSubscribe($this->guid, $guid, $data);
    }
