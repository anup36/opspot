<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div class="m-lite--header">
      <a href="https://www.ops.doesntexist.com/" style="text-decoration:none;" class="m-lite--logo">
        <img src="https://www.ops.doesntexist.com/assets/logos/medium-production.png" alt="Opspot"/>
      </a>

      <a href="https://www.ops.doesntexist.com/login" style="text-decoration:none; padding-right:8px">
        <button class="mdl-button mdl-button--raised mdl-color--blue-grey-600 mdl-color-text--white">Signup</button>
      </a>
      <a href="https://www.ops.doesntexist.com/login" style="text-decoration:none;">
