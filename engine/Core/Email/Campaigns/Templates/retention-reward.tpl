          ...
          <tr>
            <td>
              <table cellspacing="0" cellpadding="0" border="0" width="600" align="center" style="padding:16px;">
                ...
                <tr>
                  <td>
                    <a href="https://www.ops.doesntexist.com/<?= $object->ownerObj['username'] ?>?__e_ct_guid=<?= $vars['guid']?>&campaign=retention-<?= $vars['period'] ?>" style="text-decoration:none; color:#444 !important;">
