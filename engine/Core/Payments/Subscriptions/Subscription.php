...
class Subscription
{
    ...
    public function export()
    {
        ...
        //$export = \Opspot\Helpers\Export::dateTimeToTimestamp($export);
        $export = array_merge($export, \Opspot\Core\Events\Dispatcher::trigger('export:extender', 'all', ['entity' => $this], []));
