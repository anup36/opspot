<?php
$CONFIG = Opspot\Core\Di\Di::_()->get('Config');

$CONFIG->opspot_debug = true;
...
$CONFIG->set('sessions', [
    'private_key' => 'file:///.dev/opspot.pem',
    'public_key' => 'file:///.dev/opspot.pub',
]);
...
$CONFIG->cdn_url = 'https://{{domain}}/';
$CONFIG->cdn_assets_url = 'https://{{domain}}/';

$CONFIG->zmq_server = 'guidserver';
...
$CONFIG->elasticsearch = [
    'hosts' => ['elasticsearch'],
    'index' => 'opspot_badger',
    'metrics_index' => 'opspot-metrics',
    'tags_index' => 'opspot-trending-hashtags',
];
...
$CONFIG->set('blockchain', [
    ...
    'mw3' => '/usr/bin/env node ' . __OPSPOT_ROOT__ . '/../mw3/index.js'
]);
...
$CONFIG->set('tags', [
    'art', 'music', 'journalism', 'blockchain', 'freespeech', 'news', 'gaming', 'myphoto', 'nature', 'photography', 'politics', 'top', 'bitcoin', 'technology', 'food', 'animals', 'health', 'science', 'philosophy', 'comedy', 'film', 'opspot'
]);
// added 

$CONFIG->set('aws', [
    'bucket' => 'opspot-devel-01',
    'key' => 'AKIAILXKCIHSYKXWFVEQ',
    'secret' => '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',
    'region' => 'ap-south-1'
]);

// added configs
$CONFIG->max_video_length_plus = 600;
$CONFIG->max_video_length = 60;
