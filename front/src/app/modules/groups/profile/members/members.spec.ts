...
import { opspotHttpClientMock } from "../../../../mocks/common/api/opspot-http-client.service.mock";
...
describe('GroupsProfileMembers', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [
        ...
        MockComponent({ selector: 'opspot-card-user', template: '<ng-content></ng-content>', inputs: ['object'] }),
        MockComponent({ selector: 'opspot-groups-card-user-actions-button', template: '', inputs: ['group', 'user'] }),
      ...
      providers: [
        ...
        { provide: OpspotHttpClient, useValue: opspotHttpClientMock },
  ...
  beforeEach((done) => {
    ...
    opspotHttpClientMock.response = {};
    opspotHttpClientMock.response['api/v1/groups/membership/1234'] = {
      status: 'success',
      members: [
  ...
  it('should have loaded the members', () => {
    expect(opspotHttpClientMock.get).toHaveBeenCalled();
    expect(opspotHttpClientMock.get.calls.mostRecent().args[0]).toBe('api/v1/groups/membership/1234');
  });

  it('should have a opspot-groups-profile-members-invite', () => {
    expect(fixture.debugElement.query(By.css('opspot-groups-profile-members-invite'))).not.toBeNull();
  });

  it('should have a list of invitees from opspot-groups-profile-members-invite', () => {
    comp.invitees = [
  ...
  it('should have a list of members', () => {
    ...
    expect(fixture.debugElement.queryAll(By.css('.m-groupMembers__memberCard opspot-card-user')).length).toBe(2);
  });
