 ...
 */
namespace Opspot\Core\Notification;

use Opspot\Core\Data\Relationships;
...
class Entity
{
    ...
    public function getMutedUsers()
    {
        ...
        $rows = (new \Opspot\Core\Data\Call('relationships'))->getRow("{$this->guid}:entity:muted:inverted");
        ...
        if ($this->parent_guid) {
            $parentRows = (new \Opspot\Core\Data\Call('relationships'))->getRow("{$this->parent_guid}:entity:muted:inverted");
