...
class Activity extends Entity
{
    ...
    public function export()
    {
        ...
        $export = array_merge($export, \Opspot\Core\Events\Dispatcher::trigger('export:extender', 'activity', array('entity'=>$this), array()));
    ...
    {
        if (is_numeric($owner)) {
            $owner = new \Opspot\Entities\User($owner);
            $owner = $owner->export();
        }
    ...
    /**
     * Set from a local opspot object
     * @return $this
     */
    ...
    public function getRemindCount()
    {
        if ($this->remind_object) {
            return \Opspot\Helpers\Counters::get($this->remind_object['guid'], 'remind');
        }

        return \Opspot\Helpers\Counters::get($this, 'remind');
    }
