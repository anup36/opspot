...
use Opspot\Core\Payments\Stripe;
use Opspot\Core\Payments\Transfers\Transfer;
use Opspot\Core\Monetization\Ads;
use Opspot\Core\Monetization\Manager;
use Opspot\Core\Monetization\Merchants;
...
class PayoutsSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Monetization\Payouts');
    }
