...
describe('BlogCard', () => {
  ...
  it('should have an action bar with buttons', () => {
    ...
    expect(fixture.debugElement.query(By.css('.m-action-tabs opspot-button-thumbs-up'))).not.toBeNull();
    expect(fixture.debugElement.query(By.css('.m-action-tabs opspot-button-thumbs-down'))).not.toBeNull();
    expect(fixture.debugElement.query(By.css('.m-action-tabs opspot-button-comment'))).not.toBeNull();
