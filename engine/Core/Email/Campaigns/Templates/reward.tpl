  ...
  <tbody>
    ...
    <tr>
      ...
      <td height="20px" style="text-align:center;">
        <a href="<?php echo Opspot\Core\Config::_()->site_url; ?>newsfeed?__e_ct_guid=<?= $vars['guid']?>&campaign=<?= $vars['campaign']?>&validator=<?= $vars['validator'] ?>"
...
<table cellspacing="8" cellpadding="8" border="0" width="600" align="center">
  <tbody>
    ...
    <tr>
      <td style="text-align:center;">
        <a href="<?php echo Opspot\Core\Config::_()->site_url; ?>blog/featured?__e_ct_guid=<?= $vars['guid']?>&campaign=july-2016"
          style="text-decoration:none; color:#333">
          <img src="https://www.ops.doesntexist.com/assets/tutorial.png" width="450px" align="center">
        </a>
      </td>
    </tr>
          ...
          <tr>
            <td>
              <table cellspacing="0" cellpadding="0" border="0" width="600" align="center" style="padding:16px;">
                ...
                <tr>
                  <td>
                    <a href="https://www.ops.doesntexist.com/<?= $object->ownerObj['username'] ?>?__e_ct_guid=<?= $vars['guid']?>" style="text-decoration:none;">
                      <img src="https://www.ops.doesntexist.com/icon/<?= $object->owner_guid?>/small" width="24px" style="border-radius:50%; vertical-align:middle;">
                      <span style="line-height: 24px; vertical-align:middle; text-decoration:none;">@<?= $object->ownerObj['username'] ?></span>
                    </a>
                  </td>
                  <td style="text-align:right">
                    <a href="<?= $object->getURL() ?>?__e_ct_guid=<?= $vars['guid']?>" style="border:1px solid #ffc107; border-radius:3px; background:#ffc107; padding:8px; text-decoration:none; font-weight:bold; color:#FFF">Read on Opspot</a>
                  </td>
                </tr>
              </table>
            </td>
