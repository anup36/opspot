...
namespace Spec\Opspot\Core\Rewards\Withdraw;

use Opspot\Core\Blockchain\Wallets\OffChain\Balance;
use Opspot\Core\Util\BigNumber;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

use Opspot\Core\Blockchain\Pending;
use Opspot\Core\Rewards\Withdraw\Request;
use Opspot\Core\Rewards\Withdraw\Repository;
...
use Opspot\Core\Blockchain\Transactions\Manager as BlockchainTx;
...
class ManagerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Opspot\Core\Rewards\Withdraw\Manager');
    }
