...
class Router
{
    ...
    public static $routes = array(
      '/archive/thumbnail' => 'Opspot\\Controllers\\fs\\v1\\thumbnail',
      '/api/v1/archive/thumbnails' => 'Opspot\\Controllers\\api\\v1\\media\\thumbnails',

      '/oauth2/token' => 'Opspot\\Controllers\\oauth2\\token',

      '/icon' => 'Opspot\\Controllers\\icon',
      '//icon' => 'Opspot\\Controllers\\icon',
      '/api' => 'Opspot\\Controllers\\api\\api',
      '/fs' => 'Opspot\\Controllers\\fs\\fs',
      '/thumbProxy' => 'Opspot\\Controllers\\thumbProxy',
      '/wall' => 'Opspot\\Controllers\\Legacy\\wall',
      '/not-supported' => "Opspot\Controllers\\notSupported",
        //  "/app" => "opspot\\pages\\app",
      '/emails/unsubscribe' => 'Opspot\\Controllers\\emails\\unsubscribe',
      '/sitemap' => 'Opspot\\Controllers\\sitemap',

      '/apple-app-site-association' => '\\Opspot\\Controllers\\deeplinks',
      '/sitemaps' => '\\Opspot\\Controllers\\sitemaps',
    );
