...
import { OpspotCardMock } from '../../../../tests/opspot-card-mock.spec';
import { OpspotCardCommentMock } from '../../../../tests/opspot-card-comment-mock.spec';
...
describe('ReportConsoleComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [ MaterialMock, InfiniteScrollMock, OpspotCardMock, OpspotCardCommentMock, ReportConsoleComponent], // declare the test component
