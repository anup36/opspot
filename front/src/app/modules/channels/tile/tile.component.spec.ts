...
describe('ChannelsTileComponent', () => {
  ...
  it('Should load correctly', () => {
    ...
    const subscribe = fixture.debugElement.query(By.css('opspot-button-subscribe'));
    const feature = fixture.debugElement.query(By.css('opspot-button-feature'));
    const boost = fixture.debugElement.queryAll(By.css('opspot-button-boost'));
