...
//			var_dump($PLUGINS_CACHE[$plugin], $plugin);
	...
	//var_dump('tying to save yo');
		Opspot\Core\plugins::purgeCache('plugins:all');
		Opspot\Core\plugins::purgeCache('plugins:active');
		Opspot\Core\plugins::$cache == array();
	...
	public function setPriority($priority, $site_guid = null) {
		return Opspot\Core\Plugins\Priorities::set($this, $priority);
	}
