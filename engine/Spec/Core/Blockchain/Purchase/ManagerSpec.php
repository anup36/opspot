...
namespace Spec\Opspot\Core\Blockchain\Purchase;

use Opspot\Core\Blockchain\Purchase\Delegates;
use Opspot\Core\Blockchain\Purchase\Purchase;
use Opspot\Core\Blockchain\Purchase\Repository;
use Opspot\Core\Config\Config;
use Opspot\Core\Blockchain\Purchase\Delegates\EthRate;
...
class ManagerSpec extends ObjectBehavior
{
    ...
    /** @var \Opspot\Core\Blockchain\Transactions\Manager */
    protected $txManager;
    ...
    function let(
        Repository $repo,
        \Opspot\Core\Blockchain\Transactions\Manager $txManager,
        Config $config,
    ...
    {
        $this->shouldHaveType('Opspot\Core\Blockchain\Purchase\Manager');
    }
    ...
    function it_should_register_a_purchase_transaction(Purchase $purchase)
    {
        ...
        $this->txManager->add(Argument::type('Opspot\Core\Blockchain\Transactions\Transaction'))
            ->shouldBeCalled()
            ->willReturn($purchase);
